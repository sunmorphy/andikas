...
async function run() {
  console.log("Starting monorepo dev servers in order: backend ➔ cms ➔ andikas-dev...\n");
  ...
  await delay(1500); // Wait 1.5s for Vite dev server to boot

  // 3. Start Frontend
  console.log("\n⚡ [andikas-dev] Starting Next.js frontend...");
