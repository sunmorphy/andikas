        ...
        img: ({...props}: React.ImgHTMLAttributes<HTMLImageElement>) => {
            ...
            return (
                <span
                    ...
                    onClick={() => resolvedSrc && openPreview(resolvedSrc, props.alt ? String(props.alt) : undefined)}
                >
                    <img
                        {...props}
                        src={resolvedSrc}
                    ...
                    />
                    <span
                        className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity bg-neutral-950/80 text-white text-[11px] font-semibold px-3 py-1.5 rounded-full backdrop-blur-sm pointer-events-none shadow-sm">
                        Click to enlarge
                    </span>
                </span>
            );
        ...
        <article ref={containerRef} className="w-full md:w-4/5 mx-auto px-6 pt-24 pb-32 relative">
            <div className="w-full relative z-10">
                <Link href={`/${lang}/projects`}
                      className="inline-flex items-center gap-2 text-xs font-bold text-neutral-400 hover:text-brand-900 transition-colors mb-12 md:mb-32 uppercase tracking-widest cursor-pointer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 w-full items-start relative pl-6 md:pl-0">
                    <div
                        className="absolute left-2 md:left-[33.33%] top-0 bottom-0 w-[1px] bg-neutral-200 pointer-events-none"/>
                    <motion.div
                    ...
                    <aside
                        className="col-span-12 md:col-span-4 md:sticky md:top-28 self-start flex flex-col gap-8 w-full pr-0 md:pr-6 lg:pr-12 pl-0">
                        <div
                            className="flex flex-col gap-5 text-[10px] font-bold uppercase tracking-wider text-neutral-500">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span
                                    className="text-neutral-900 text-xs font-black">{project.type === 'group' ? dict.projects.groupProject : dict.projects.personalProject}</span>
                            </div>
                            <div className="flex flex-col gap-1 border-t border-neutral-100 pt-3">
                                ...
                                <span
                                    className="text-neutral-900 text-xs font-black">{project.projectTags?.map(t => t.tag.name).join(" / ") || "N/A"}</span>
                            </div>
                            <div className="flex flex-col gap-1 border-t border-neutral-100 pt-3">
                    ...
                    <div className="col-span-12 md:col-span-8 flex flex-col gap-16 w-full pl-0 md:pl-12">
                        ...
                        >
                            <ReactMarkdown remarkPlugins={[remarkGfm]}
                                           components={markdownComponents}>{project.description}</ReactMarkdown>
                        </motion.div>
                        ...
                        {project.coverImage && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        className="absolute inset-0 bg-neutral-950/0 group-hover:bg-neutral-950/20 transition-colors flex items-end justify-end p-4">
                                        <span
                                            className="opacity-0 group-hover:opacity-100 transition-opacity bg-neutral-950/80 text-white text-xs font-semibold px-3 py-1.5 rounded-full backdrop-blur-sm shadow-sm pointer-events-none">
                                            Click to enlarge
                                        </span>
                                    </div>
                                </motion.div>
                        ...
                        {project.content && (
                            ...
                            >
                                <ReactMarkdown remarkPlugins={[remarkGfm]}
                                               components={markdownComponents}>{project.content}</ReactMarkdown>
                            </motion.section>
                        )}
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 z-10">
                        <Link href={`/${lang}/projects`}
                              className="text-xs font-black uppercase tracking-widest text-neutral-400 hover:text-brand-900 transition-colors">
                ...
                {previewImage && (
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                className="text-xs font-bold text-neutral-300 min-w-[44px] text-center tracking-wider">
                        ...
                        >
                            {/* Image Box */}
                            <div
                                className="relative overflow-hidden rounded-xl border border-neutral-800 shadow-2xl bg-neutral-950 max-h-[82vh] flex items-center justify-center">
                                <motion.div
                                    drag={zoomScale > 1}
                                    dragConstraints={{
                                        left: -300 * zoomScale,
